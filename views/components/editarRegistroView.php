<?php
// components/editarRegistroView.php
function editarRegistroView()
{ ?>
    <a class="btn btn-success my-auto" href="" data-bs-toggle="modal"
        data-bs-target="<?= "#modalEditarRegistro" ?>"> Editar registro</a>
    <div
        class="modal fade"
        ...
        <div
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="max-w-md mx-auto" action="../controllers/editarRegistroController.php" method="post">
                        <div class="mb-3">
